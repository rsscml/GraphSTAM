...
class graphmodel:
    ...
    def create_snapshot_graph(self, df_snap, period):
        ...
        df_snap_target = pd.pivot_table(df_snap, values=self.target_col, index=self.id_col, columns=self.time_index_col, dropna=False, sort=False).reset_index(drop=False)
        ...
        df_snap_mask = pd.pivot_table(df_snap, values=self.target_col, index=self.id_col, columns=self.time_index_col, dropna=False, sort=False).reset_index(drop=False)
        ...
        df_snap_recency_wt = pd.pivot_table(df_snap, values='recency_weights', index=self.id_col, columns=self.time_index_col, dropna=False, sort=False).reset_index(drop=False)
        ...
        for known_col in self.temporal_known_num_col_list:
            ...
            df_snap_known_num_col = pd.pivot_table(df_snap, values=known_col, index=self.id_col, columns=self.time_index_col, dropna=False, sort=False).reset_index(drop=False)
        ...
        for unknown_col in self.temporal_unknown_num_col_list:
            ...
            df_snap_unknown_num_col = pd.pivot_table(df_snap, values=unknown_col, index=self.id_col, columns=self.time_index_col, dropna=False, sort=False).reset_index(drop=False)
        ...
        for known_onehot_col in self.known_onehot_cols:
            ...
            df_snap_known_onehot_col = pd.pivot_table(df_snap, values=known_onehot_col, index=self.id_col, columns=self.time_index_col, dropna=False, sort=False).reset_index(drop=False)
        ...
        for unknown_onehot_col in self.unknown_onehot_cols:
            ...
            df_snap_unknown_onehot_col = pd.pivot_table(df_snap, values=unknown_onehot_col, index=self.id_col, columns=self.time_index_col, dropna=False, sort=False).reset_index(drop=False)
