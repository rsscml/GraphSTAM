...
class graphmodel():
    ...
    def train(self, 
        ...
        for epoch in range(max_epochs):
            ...
            if stop_training_criteria in ['mse', 'mae']:
                save_condition = ((val_metric_hist[epoch] == np.min(val_metric_hist)) and (-val_loss_delta > min_delta) and (-train_loss_delta > min_delta)) or (epoch == 0)
                print("Improvement delta (min_delta {}):  {}".format(min_delta, train_loss_delta))
            else:
